...
namespace CompanyName.MyProjectName.BuildingBlocks.API.Exceptions.Mappers;
...
internal sealed class ExceptionToResponseMapper : IExceptionToResponseMapper
{
    ...
    private readonly ExceptionResponse _communicationResponse = new(
        new ErrorsResponse(new Error("internal_service_http_communication", "There was an internal HTTP service communication error.")), HttpStatusCode.InternalServerError);
