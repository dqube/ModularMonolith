...
namespace CompanyName.MyProjectName.BuildingBlocks.API.Networking;
...
public static class Extensions
{
    ...
    public static IApplicationBuilder UseHeadersForwarding(this IApplicationBuilder app)
    {
        ...
        {
            knownNetworks.Add(new Microsoft.AspNetCore.HttpOverrides.IPNetwork(IPAddress.Parse(DefaultIpAddress), 8));
        }
        else
        {
            options.Networks
