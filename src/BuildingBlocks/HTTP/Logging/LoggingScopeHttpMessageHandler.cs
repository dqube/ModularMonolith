...
namespace CompanyName.MyProjectName.BuildingBlocks.HTTP.Logging;
...
#pragma warning restore CS8619 // Nullability of reference types in value doesn't match target type.
        ...
        public static IDisposable BeginRequestPipelineScope(
            ILogger logger, HttpRequestMessage request, ISet<string> maskedRequestUrlParts, string maskTemplate)
        {
        ...
        public static void HandleRequestPipelineStart(
            ILogger logger, HttpRequestMessage request, ISet<string> maskedRequestUrlParts, string maskTemplate)
        {
            var uri = MaskUri(request.RequestUri, maskedRequestUrlParts, maskTemplate);
