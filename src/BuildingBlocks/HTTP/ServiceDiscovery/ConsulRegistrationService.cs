...
public class ConsulRegistrationService : IHostedService
{
    ...
    public ConsulRegistrationService(
        IConsulClient client, IServiceDiscoveryRegistration serviceDiscoveryRegistration, IOptions<ConsulOptions> options, ILogger<ConsulRegistrationService> logger)
    {
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        var result = await _client.Agent.ServiceRegister(
